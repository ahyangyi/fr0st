...
class RenderStats(Structure):
    _fields_ = [("badvals", c_double), ("num_iters", c_long), ("render_seconds", c_int)]
...
class PaletteEntry(Structure):
    _fields_ = [("index", c_double), ("color", c_double * 4)]
...
libflam3.flam3_colorhist.argtypes = [
    POINTER(BaseGenome),
    c_int,
    POINTER(RandomContext),
    POINTER(c_double),
]
...
libflam3.flam3_xform_preview.argtypes = [
    POINTER(BaseGenome),
    c_int,
    c_double,
    c_int,
...
libflam3.flam3_random.argtypes = [
    POINTER(BaseGenome),
    POINTER(c_int),
    c_int,
    c_int,
...
libflam3.flam3_render.argtypes = [
    POINTER(BaseFrame),
    POINTER(c_ubyte),
    c_int,
    c_int,
...
libflam3.flam3_interpolate.argtypes = [
    POINTER(BaseGenome),
    c_int,
    c_double,
    c_double,
...
libflam3.flam3_estimate_bounding_box.argtypes = [
    POINTER(BaseGenome),
    c_double,
    c_int,
    POINTER(c_double),
